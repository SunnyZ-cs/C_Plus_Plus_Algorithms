 ...
 * more about this!
 */
const char MyName[] = "Sunny";

/* Change these constants to contain the paths out of your mazes. */
const char ThePathOutOfMyMaze[] = "EEESNWWSWSSNEESEN";
const char ThePathOutOfMyTwistyMaze[] = "EWEEWSENNESN";

STUDENT_TEST("Escape from the labyrinth!") {
...
STUDENT_TEST("Escape from the twisty labyrinth!") {
