...
public:
     ...
     * StringInstrument. (Take ProjectL for details!)
     */
     ...
     * copy project operator. They're covered in detail in the
     * textbook (Ch 12.7) and in ProjectL. Because we didn't cover these
