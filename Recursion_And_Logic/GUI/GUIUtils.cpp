...
shared_ptr<TextRender> TextRender::construct(const string& text,
     ...
     *
     * Note: This is a silly O(n)-time algorithm. Use binary search instead?
     */
...
shared_ptr<LegendRender> LegendRender::construct(const vector<string>& strings,
     ...
     *
     * Note: This uses a silly O(n)-time algorithm. Switch to binary search?
     */
    ...
    while (true) {
        ...
        /* Note: Short-circuit if we fail early? */
